...
You can add an optional skill file that teaches Claude Code **when and how** to pick the right Leeroopedia tool. This improves tool selection, encourages parallel searches, and provides canonical workflows for common tasks.

Download [`SKILL.md`](https://raw.githubusercontent.com/Leeroo-AI/leeroopedia-mcp/main/SKILL.md) and paste its contents into your project's `CLAUDE.md` file (create one if it doesn't exist). Claude Code reads this file automatically at the start of every session.
